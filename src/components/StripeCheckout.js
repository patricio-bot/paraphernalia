    ...
    <div>
      ...
      <form id='payment-form' onSubmit={handleSubmit}>
        ...
        <p className={succeeded ? 'result-message' : 'result-message hidden'}>
          Payment succeeded, see the result in your <a rel='noreferrer' target='_blank' href={`https://dashboard.stripe.com/test/payment`}>Stripe dashboard.</a><br /> Refresh the page to pay again!
        </p>
      </form>
    </div>
  )
